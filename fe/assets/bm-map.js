require([
    ...
    var ruas_jalan = new FeatureLayer({
            ...
            if (resp.results.length) {
                ...
                summary.queryFeatures(query).then(result => {
                    if(result.features.length) {
                        ...
                        var map_data = result.features[0].attributes;
                        this.stpArr = map_data;
                        this.stpArr.no_pengajuan = document.getElementById("nomor_surat").value;
                        this.stpArr.provinsi = document.getElementById("provinsi").value;
                        // this.stpArr.object_id = map_data.OBJECTID;
                        // this.stpArr.idprov = map_data.
